...
**Technical Credits**
 ...
 - [**Truepak (Greatestbear)**](https://discussions.unity.com/t/the-quest-for-efficient-per-texel-lighting/700574): Per-texel snapping logic and math. (MIT License in [PSXLighting_URP.hlsl](https://github.com/Colby-O2/VNTG/blob/master/Shaders/HLSL/PSXLighting_URP.hlsl#L86))
